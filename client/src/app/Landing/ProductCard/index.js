  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      ...
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <p className="py-8 leading-relaxed">{product?.description}</p>{/*brand*/}
        <div class="flex flex-row gap-4 items-baseline">
                  ...
                  <input
                    ...
                    class="mb-10 shadow appearance-none border rounded w-full py-2 px-3 text-dark leading-tight focus:outline-none focus:shadow-outline"
                    name="quantity"
                    id="quantity"
                    type="number"
                    min={0}
